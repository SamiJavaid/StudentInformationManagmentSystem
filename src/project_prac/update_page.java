...
return id;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String district=jComboBox3.getSelectedItem().toString();
        ...
        try {
            pst=Ex_con.con.prepareStatement("update add_page set name='"+jTextField1.getText()+"',father_name='"+jTextField2.getText()+"',gender = '"+gender+"',postal_address='"+jTextField3.getText()+"',personal_address='"+jTextField4.getText()+"',city='"+city+"',course='"+course+"',district='"+district+"',mobile_no='"+jTextField5.getText()+"'where id="+getid());
            pst.executeUpdate();
            cl();
